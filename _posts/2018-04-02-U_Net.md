...
이 전략은, 전체 U-Net 아키텍쳐에서 input[572X572] -> output[388X388] 로 Segmentation map이 만들어 질때, 위의 그림에서 보는 것과 같이 border부분에서 정보가 없는 빈 부분이 발생하게 되는데요.

![u-net_fig_1_ex](../assets/images/posts/2018-04-02-U_Net/u-net_fig_1_ex.png)
...
![u-net_fig_2_ex](../assets/images/posts/2018-04-02-U_Net/u-net_fig_2_ex.png)
...
![1_cross_entropy](../assets/images/posts/2018-04-02-U_Net/u-net_cross_entropy.png)

$$w(\mathbf x)$$ **구하는 법 :**

![2_wx](../assets/images/posts/2018-04-02-U_Net/u-net_wx.png)

$$w(\mathbf x)$$는 두개의 텀의 합으로 구성됩니다. $$w(\mathbf x)$$는 $$x$$ 위치의 픽셀에 가중치를 부여하는 함수입니다. 
...
![Table1](../assets/images/posts/2018-04-02-U_Net/u-net_table1.png)
